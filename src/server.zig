...
const ServerConnection = @import("connection.zig").ServerConnection;
...
pub const HttpServer = struct {
    ...
    // TODO: Don't need to throw errors as we have assumed capacity for date
